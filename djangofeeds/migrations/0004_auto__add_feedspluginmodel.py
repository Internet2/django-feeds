...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedsPluginModel'
        db.create_table('cmsplugin_feedspluginmodel', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=240, blank=True)),
            ('feeds', self.gf('django.db.models.fields.CharField')(max_length=240, blank=True)),
            ('limit', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('more', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('djangofeeds', ['FeedsPluginModel'])


    def backwards(self, orm):
        # Deleting model 'FeedsPluginModel'
        db.delete_table('cmsplugin_feedspluginmodel')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
