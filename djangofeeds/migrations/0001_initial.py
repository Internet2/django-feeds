...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Feed'
        db.create_table('djangofeeds_feed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('djangofeeds', ['Feed'])
        ...
        db.create_table('djangofeeds_enclosure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('djangofeeds', ['Enclosure'])

        # Adding model 'Post'
        db.create_table('djangofeeds_post', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('djangofeeds', ['Post'])

        # Adding M2M table for field enclosures on 'Post'
        db.create_table('djangofeeds_post_enclosures', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['djangofeeds.post'], null=False)),
            ('enclosure', models.ForeignKey(orm['djangofeeds.enclosure'], null=False))
        ))
        db.create_unique('djangofeeds_post_enclosures', ['post_id', 'enclosure_id'])
